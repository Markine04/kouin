                                        ...
                                        @foreach ($validations as $item)
                                            <tr>
                                                ...
                                                <td class="cell"><span class="truncate"> <a
                                                            href="{{ route('contenu.show', ['id' => $item->id]) }}">{{ $item->libelle }}</a>
                                                    </span></td>
                                                ...
                                                <td class="cell">
                                                    @switch($item->is_active)
                                                        ...
                                                        @case('1')
                                                            <span class="badge bg-warning">En attente de validation par
                                                                l'admin</span>
                                                    ...
                                                    <td class="cell">
                                                        @if ($item->is_active == 1)
                                                            <a class="btn-sm app-btn-secondary"
                                                                href="{{ route('validations.valide', ['id' => $item->id]) }}"><i
                                                                    class="fa fa-check" style="color:rgb(12, 146, 83);"></i></a>

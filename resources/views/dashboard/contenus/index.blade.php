                ...
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <form class="docs-search-form row gx-1 align-items-center" method="GET" action="">
                                ...
                                <div class="col-auto">
                                    <input type="text" id="search-docs" name="searchdocs" class="form-control"
                                        placeholder="Search" value="{{ $searchdocs }}">
                                </div>
                                <div class="col-auto">
                                    <select name="type_search" id="type_search" class="form-select w-auto">
                                        ...
                                        @foreach ($type_offres_search as $type_offres_sear)
                                            <option
                                                value="{{ $type_offres_sear->id }}"{{ $type_offres_sear->id == $type_search ? 'selected' : '' }}>
                                                {{ $type_offres_sear->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-auto">
                                    <select name="statut" class="form-select w-auto">
                                        ...
                                        <option value="2" {{ $statut === '2' ? 'selected' : '' }}>Expirer</option>
                            ...
                            <div class="col-auto">
                                <a class="btn app-btn-primary" href="{{ route('contenu.create') }}"><i
                            ...
                            <div class="app-card-body p-3 has-card-actions">
                                ...
                                <div class="app-doc-meta">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><span class="text-muted">Type Offre:</span>
                                            {{ $type_offres[$offre->type_offre_id] ?? '' }}</li>
                                        <li><span class="text-muted">Formation:</span>
                                            {{ $secteurs[$offre->formation_id] ?? '' }}</li>
                                        <li><span class="text-muted">Date ajout:</span>
                                           <b>{{ date('d/m/Y', strtotime($offre->date_publication)) }}</b></li>
                                        <li><span class="text-muted">Date suppression:</span>
                                           <label style="color: tomato"><b>{{ date('d/m/Y', strtotime($offre->date_expiration)) }}</b></label>
                                        </li>
                                    </ul>
                                </div><!--//app-doc-meta-->
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('contenu.show', ['id' => $offre->id]) }}"><svg
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="{{ route('contenu.delete', ['id' => $offre->id]) }}"><svg
                                                        width="1em" height="1em" viewBox="0 0 16 16"
